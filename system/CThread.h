...
public:
    ...
    //! constructor
    CThread(int32_t iAttr, int32_t iPriority = 16, int32_t iStackSize = 0x8000, CThread::Callback callback = NULL, char *callbackArg = NULL)
        : pThread(NULL)
        , pThreadStack(NULL)
        , pCallback(callback)
 ...
 */
    ...
    static CThread *create(CThread::Callback callback, char *callbackArg, int32_t iAttr = eAttributeNone, int32_t iPriority = 16, int32_t iStackSize = 0x8000) {
